/**
 * Entry point for the Data Structure Traversal application.
 * Handles the main flow of selecting data structures, reading input files,
 * and executing graph or tree traversal algorithms.
 */
